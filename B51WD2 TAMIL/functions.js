...
// verb
 function funname(){
    console.loh("statement 1");
    console.loh("statement 2");
    console.loh("statement 3");
    console.loh("statement 4");
 }
 // intha staement ellame intha function-kull than ex aagum
console.log(a);
var a = 15;
console.log(a);
...
//     console.log(`Hi ${name},nice to meet u man`);
// }
// giveYourName("esakkiPandian");

// function giveYourName(name, name1){
//     console.log(`Hi ${name} and ${name1}, nive to meet u guys`);
// }
// giveYourName("esakk" , "sundar");

// function giveYourName(name){
//     console.log(`hey ${name}, welcome to givi`);
// }
// giveYourName("esakki pandian");

// function greetme(name){
//     return `hey ${name}welcome to guvi`;
// }
// function funExcututeGreetfuc(fn, args){
//     console.log(fn(args));
// }
